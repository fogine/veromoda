...
registry.getBySingularName('coupon').belongsTo(registry.getBySingularName('value_type'));
...
registry.getBySingularName('product_item').belongsToMany(
    registry.getBySingularName('image'),
    {
        through: {resource: registry.getBySingularName('image_product_item')}
    }
);

registry.getBySingularName('image_product_item').belongsTo(registry.getBySingularName('image_type'));
registry.getBySingularName('image_product_item').belongsTo(registry.getBySingularName('image'));
registry.getBySingularName('image_product_item').belongsTo(registry.getBySingularName('product_item'));
